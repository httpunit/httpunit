...
echo "listen = 127.0.0.1:9000" >> ~/.phpenv/versions/$(phpenv version-name)/etc/php-fpm.conf
echo "listen.allowed_clients = 127.0.0.1" >> ~/.phpenv/versions/$(phpenv version-name)/etc/php-fpm.conf
